...
void SiftUp(RandIt begin, RandIt iter, Comparator comp = Comparator(), Swapper swap = Swapper()) {
...
template <class RandIt, class Comparator = std::less<>, class Swapper = Swapper>
void SiftDown(RandIt begin, RandIt end, RandIt iter, Comparator comp = Comparator(),
...
template <class RandIt, class Comparator = std::less<>, class Swapper = Swapper>
void RestoreHeap(RandIt begin, RandIt end, RandIt iter, Comparator comp = Comparator(),
                 Swapper swap = Swapper()) {
...
template <class RandIt, class Comparator = std::less<>, class Swapper = Swapper>
void PopHeap(RandIt begin, RandIt end, Comparator comp = Comparator(), Swapper swap = Swapper()) {
